...
::: {.column width="60%"}
**Welche statistischen Maße können wir NICHT berechnen?**
...
- **Standardfehler** ✗
- **Konfidenzintervalle** ✗
- **t-Test** (oder andere statistische Tests) ✗

**Selbst vermeintlich einfache Maße sind problematisch:**

- Mittelwert? → Von einem Wert? Sinnlos.
- Minimum/Maximum? → Gibt nur diesen einen Wert.
:::

<br>

::: {.callout-warning}
**Mit n=1 pro Behandlung:** Null Information über die Variabilität innerhalb einer Behandlung!
:::
:::
::::
