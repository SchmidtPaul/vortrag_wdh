...
ggplot(field, aes(x = col, y = row, fill = treatment)) +
  ...
  scale_fill_manual(values = c("A" = "#00923f", "B" = "#bce2cc", "C" = "#4758ab")) +
  labs(title = "Vollständig randomisiertes Design (CRD)",
       subtitle = "Behandlungen sind zufällig über das Feld verteilt") +
  theme_void() +
  theme(plot.title = element_text(size = 18, face = "bold", hjust = 0.5, family = "Arial"),
...
ggplot(field_bad, aes(x = col, y = row, fill = treatment)) +
  ...
  theme_void() +
  theme(plot.title = element_text(size = 18, face = "bold", hjust = 0.5, color = "#ad0000", family = "Arial"),
        plot.subtitle = element_text(size = 14, hjust = 0.5, color = "#ad0000", family = "Arial"),
        legend.position = "bottom",
        legend.title = element_blank(),
        legend.text = element_text(size = 12, family = "Arial"))
```
...
ggplot(field_split, aes(x = col, y = row, fill = A)) +
  ...
  scale_fill_manual(values = c("A1" = "#00923f", "A2" = "#ad0000")) +
  ...
  theme_void() +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5, color = "#ad0000", family = "Arial"),
